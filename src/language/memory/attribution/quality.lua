act(std.quality.acts,function(space)
...
simple_word("is"):where(std.is_a,verb):where(std.is_a,present_verb):where(std.repr,std.quality)
add(words.is.acts,quality_act)
simple_word("am"):where(std.is_a,verb):where(std.is_a,present_verb):where(std.repr,std.quality)
add(words.am.acts,quality_act)
simple_word("are"):where(std.is_a,verb):where(std.is_a,present_verb):where(std.repr,std.quality)
add(words.are.acts,quality_act)
simple_word("was"):where(std.is_a,verb):where(std.is_a,past_verb):where(std.repr,std.quality)
add(words.was.acts,quality_act)
simple_word("were"):where(std.is_a,verb):where(std.is_a,past_verb):where(std.repr,std.quality)
